...
class OfferService:
    ...
    def insert_total_offer(self, supplier_username: str, project_id: str, business_category_id: str) -> str:
        return self.db.new_table_record(table='TotalOffer', record={
    ...
    def insert_task_offer(self, total_offer_id: str, project_task_id: str, price_offer: float):
        return self.db.new_table_record(table='TaskOffer', record={
